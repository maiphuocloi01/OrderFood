...
INSERT [dbo].[Products] ([Id], [Name], [Detail], [ImageUrl], [Price], [IsPopularProduct], [CategoryId]) VALUES (21, N'Completo', N' served with ingredients such as chopped tomatoes, avocados, mayonnaise, sauerkraut, salsa Americana, ají pepper and green sauce. It can be twice the size of an American hot dog.', N'hot_dog3.jpg', 6, 0, 5)
INSERT [dbo].[Products] ([Id], [Name], [Detail], [ImageUrl], [Price], [IsPopularProduct], [CategoryId]) VALUES (22, N'Danger Dog', N'Bacon-wrapped grilled hot dogs topped with mustard, ketchup, mayo, grilled onions and peppers, fresh pico de gallo, and often topped with a grilled jalapeño pepper.', N'hot_dog4.jpg', 6, 0, 5)
